...
def main():
    ...
    print("""
  ###########################################
  # Intercept Development Environment Setup #
  ###########################################

  This script will create your Intercept dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your Intercept project folder:
    [Arma 3 installation directory]\\{} => Intercept project folder
    P:\\{}                              => Intercept project folder
...
if __name__ == "__main__":
    ...
    if exitcode > 0:
        print("\nSomething went wrong during the setup. Make sure you run this script as administrator. If these issues persist, please follow the instructions on the Intercept wiki to perform the setup manually.")
    else:
